  ...
  getMachineCompareData = data => { 
   ...
   // let tempData = Object.assign({}, data);
    ...
    if (data.firstMachineId != '') {
      machine_names.push(data.firstMachineId.assosiativeMachineName);
    }
    if(data.secondMachineId != '') { 
      machine_names.push(data.secondMachineId.assosiativeMachineName);
    }
    if(data.thirdMachineId != '') {
      machine_names.push(data.thirdMachineId.assosiativeMachineName);
    }
    if(data.fourthMachineId != '') {
      machine_names.push(data.fourthMachineId.assosiativeMachineName);
    }
